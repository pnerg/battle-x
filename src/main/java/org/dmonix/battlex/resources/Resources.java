...
//  public static final int PIECE_FLAG_COUNT = 1;
  ...
  public static final int TOTAL_PIECES = PIECE_BOMB_COUNT +
                                         PIECE_MARSHAL_COUNT +
                                         PIECE_GENERAL_COUNT +
                                         PIECE_COLONEL_COUNT +
                                         PIECE_MAJOR_COUNT +
                                         PIECE_CAPTAIN_COUNT +
                                         PIECE_LIEUTENANT_COUNT +
                                         PIECE_SERGEANT_COUNT +
                                         PIECE_MINER_COUNT +
                                         PIECE_SCOUT_COUNT +
                                         PIECE_SPY_COUNT +
                                         PIECE_FLAG_COUNT;
  ...
  public static BufferedImage getBackgroundImage(int player)
  {
    try
    {
      return ImageIO.read(Resources.class.getResource("/org/dmonix/battlex/images/player" + player +"/battlexmap_large.jpg"));
    }
...
//    return (Image)Resources.class.getDeclaredField("IMG_PLAYER"+player+"_PIECE"+type).get(Resources.class);
  ...
  private static Image getImage(int player, int type, int scale) {
    Image image = new ImageIcon(Resources.class.getResource("/org/dmonix/battlex/images/player" + player +"/battlex-piece-" + type + ".gif")).getImage();
